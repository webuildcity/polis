...
STARTPAGE_TOPIC_ICONS = [
    {'text' : 'Wirtschaft', 'icon': 'fa-line-chart', 'overlay': 'Wirtschaft', 'link' : reverse_lazy('search'), 'params' : 'tags=Wirtschaft'  },
    ...
    {'text' : 'Kultur', 'icon': 'fa-coffee', 'overlay': 'Kulturprojekte und Ideen', 'link' : reverse_lazy('search'), 'params' : 'tags=Kultur'  },
    {'text' : 'Zivilgesellschaft', 'icon': 'fa-university', 'overlay': 'Zivilgesellschaft / Ehrenamt', 'link' : reverse_lazy('search'), 'params' : 'tags=Zivilgesellschaft'  },
